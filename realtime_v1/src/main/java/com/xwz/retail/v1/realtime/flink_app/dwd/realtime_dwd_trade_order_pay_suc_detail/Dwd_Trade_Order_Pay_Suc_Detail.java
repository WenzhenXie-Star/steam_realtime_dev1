package com.xwz.retail.v1.realtime.flink_app.dwd.realtime_dwd_trade_order_pay_suc_detail;
...
/**
 * @Package com.xwz.retail.v1.realtime.flink_app.dwd.realtime_dwd_trade_order_pay_suc_detail.Dwd_Trade_Order_Pay_Suc_Detail
 * @Author  Wenzhen.Xie
...
public class Dwd_Trade_Order_Pay_Suc_Detail extends BaseSQLApp {
    public static void main(String[] args) {
        new Dwd_Trade_Order_Pay_Suc_Detail().start(
                10016,
                4,
