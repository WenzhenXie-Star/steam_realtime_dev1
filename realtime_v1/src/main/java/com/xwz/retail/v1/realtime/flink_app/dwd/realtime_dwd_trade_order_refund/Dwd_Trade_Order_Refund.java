package com.xwz.retail.v1.realtime.flink_app.dwd.realtime_dwd_trade_order_refund;
...
/**
 * @Package com.xwz.retail.v1.realtime.flink_app.dwd.realtime_dwd_trade_order_refund.Dwd_Trade_Order_Refund
 * @Author  Wenzhen.Xie
...
public class Dwd_Trade_Order_Refund  extends BaseSQLApp {
    public static void main(String[] args) {
        new Dwd_Trade_Order_Refund().start(
                10016,
                4,
