...
import com.xwz.retail.v1.realtime.bean.UserLoginBean;
...
/**
 * @Package com.xwz.retail.v1.realtime.flink_app.dws.Dws_User_Login_Window
 * @Author  Wenzhen.Xie
 * @Date  2025/4/23 15:41
 * @description: 
*/

public class Dws_User_Login_Window extends BaseApp {
    public static void main(String[] args) throws Exception {
        new Dws_User_Login_Window().start(
                10024,
                4,
