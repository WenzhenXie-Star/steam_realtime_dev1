...
import com.xwz.retail.v1.realtime.function.KeywordUDTF;
import com.xwz.retail.v1.realtime.utils.SQLUtil;
import org.apache.flink.table.api.Table;
import org.apache.flink.table.api.bridge.java.StreamTableEnvironment;

/**
 * @Package com.xwz.retail.v1.realtime.flink_app.dws.Dws_Traffic_Source_Keyword_Page_View_Window
 * @Author  Wenzhen.Xie
 * @Date  2025/4/23 15:36
 * @description: 
*/

public class Dws_Traffic_Source_Keyword_Page_View_Window extends BaseSQLApp {
    public static void main(String[] args) {
        new Dws_Traffic_Source_Keyword_Page_View_Window().start(
                10021,
                4,
