package com.xwz.retail.v1.realtime.flink_app.dwd.realtime_dwd_trade_refund_pay_suc_detail;
...
/**
 * @Package com.xwz.retail.v1.realtime.flink_app.dwd.realtime_dwd_trade_refund_pay_suc_detail.Dwd_Trade_Refund_pay_Suc_Detail
 * @Author  Wenzhen.Xie
 * @Date  2025/4/22 14:08
 * @description: 
*/

public class Dwd_Trade_Refund_pay_Suc_Detail extends BaseSQLApp {
    public static void main(String[] args) {
        new Dwd_Trade_Refund_pay_Suc_Detail().start(
                10018,
                4,
