package com.xwz.retail.v1.realtime.flink_app.dwd.realtime_dwd_trade_order_detail;

import com.xwz.retail.v1.realtime.base.BaseSQLApp;
import com.xwz.retail.v1.realtime.constant.Constant;
import com.xwz.retail.v1.realtime.utils.SQLUtil;
...
/**
 * @Package com.xwz.retail.v1.realtime.flink_app.dwd.realtime_dwd_trade_order_detail.Dwd_Trade_Order_Detail
 * @Author  Wenzhen.Xie
 * @Date  2025/4/22 14:01
 * @description: 
*/

public class Dwd_Trade_Order_Detail extends BaseSQLApp {
    public static void main(String[] args) {
        new Dwd_Trade_Order_Detail().start(10014,4, Constant.TOPIC_DWD_TRADE_ORDER_DETAIL);
    }
    @Override
